...
if __name__ == "__main__":
    ...
    #cf24hist = c24.train("facecalib24.h5","data/faces/adj24/train","data/faces/adj24/validation")
    df48hist = d48.train("facedetect48.h5","data/faces/detect48/train","data/faces/detect48/validation")
    #cf48hist = c48.train("facecalib48.h5","data/faces/adj48/train","data/faces/adj48/validation")
    ...
    #ch24hist = c24.train("handcalib24.h5","data/hands/adj24/train","data/hands/adj24/valid",tags=["hand","nothand"])
    dh48hist = d48.train("handdetect48.h5","data/hands/detect48/train","data/hands/detect48/valid",tags=["hand","nothand"])
    #ch48hist = c48.train("handcalib48.h5","data/hands/adj48/train","data/hands/adj48/valid",tags=["hand","nothand"])

    p = plotmodel()
    #p.displayhist("detect face 12",df12hist.history)
    #p.displayhist("detect hand 12",dh12hist.history)
    #p.displayhist("calib face 12",cf12hist.history)
    #p.displayhist("calib hand 12",ch12hist.history)
    #p.displayhist("detect face 24",df24hist.history)
    #p.displayhist("detect hand 24",dh24hist.history)
    #p.displayhist("calib face 24",cf24hist.history)
    #p.displayhist("calib hand 24",ch24hist.history)
    p.displayhist("detect face 48",df48hist.history)
    p.displayhist("detect hand 48",dh48hist.history)
    #p.displayhist("calib face 48",cf48hist.history)
    #p.displayhist("calib hand 48",ch48hist.history)
